...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"C:\Users\SamMorgan\Downloads\Coseismic-landslide-detection-main\Coseismic-landslide-detection-main\landsldie_detection_code\code\Unet_Resnet\data/", help="VOCdevkit root")                     # 数据集路径
